...
const resources = {
  en: {
    translation: {
      ...
      'user.retrieved_multiple': 'Users retrieved successfully',
  ...
  es: {
    translation: {
      ...
      'user.retrieved': 'Usuario obtenido exitosamente',
      'user.retrieved_multiple': 'Usuarios obtenidos exitosamente',
